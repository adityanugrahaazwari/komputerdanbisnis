    ...
    <form action="{{ route('gallery-groups.store') }}" method="POST">
        ...
        <div class="space-y-6">
            <div class="space-y-2">
                ...
                <input type="text" name="name" class="w-full bg-gray-50 dark:bg-slate-800 border-none rounded-2xl px-6 py-4 focus:ring-2 focus:ring-red-600 transition-all font-bold text-gray-900 dark:text-white" value="{{ old('name') }}" placeholder="Misal: Wisuda 2026" required>
