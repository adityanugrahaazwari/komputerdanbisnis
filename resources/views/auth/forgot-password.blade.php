...
<head>
    ...
    <title>Lupa Password - JKB POLITALA</title>
...
<body class="login-gradient flex items-center justify-center min-h-screen p-4">
    ...
    <div class="max-w-md w-full">
        ...
        <div class="bg-white/95 backdrop-blur-md p-10 rounded-[2.5rem] shadow-2xl relative overflow-hidden">
            ...
            <h2 class="text-2xl font-black text-gray-900 mb-4">Lupa Password?</h2>
            <p class="text-gray-500 text-sm mb-8">Masukkan email Anda untuk menerima link pengaturan ulang kata sandi.</p>

            @if(session('status'))
                <div class="bg-green-50 border-l-4 border-green-600 text-green-700 p-4 mb-8 rounded-r-lg" role="alert">
                    <p class="font-bold text-sm uppercase mb-1">Berhasil</p>
            ...
            <form action="{{ route('password.email') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="email" name="email" value="{{ old('email') }}" required autofocus class="w-full pl-11 pr-4 py-4 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-2 focus:ring-primary focus:bg-white transition-all outline-none text-gray-700 font-medium" placeholder="nama@email.com">
                    </div>
                </div>
            ...
            <div class="mt-8 pt-6 border-t border-gray-100 text-center">
                <a href="{{ route('login') }}" class="text-primary text-xs font-black uppercase tracking-widest hover:underline">
                    Kembali ke Login
                </a>
            </div>
        </div>
