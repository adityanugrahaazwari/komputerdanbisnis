    ...
    <form action="{{ route('study_programs.update', $studyProgram->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="mb-4">
                ...
                <input type="url" name="website_url" class="w-full border rounded px-3 py-2 @error('website_url') border-red-500 @enderror" value="{{ old('website_url', $studyProgram->website_url) }}" placeholder="https://prodi.politala.ac.id">
