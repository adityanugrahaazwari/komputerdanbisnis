...
@section('header', 'Edit Dosen/Staf')

@section('content')
<div class="bg-white rounded-[2rem] shadow-sm border border-gray-100 p-8">
    <div class="mb-8">
        <h3 class="text-xl font-black text-gray-900 uppercase tracking-tight">Edit Dosen/Staf</h3>
        <p class="text-gray-500 text-sm">Perbarui data {{ $lecturer->name }}.</p>
    </div>
    ...
    <form action="{{ route('lecturers.update', $lecturer->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="mb-4">
                ...
                <input type="email" name="email" class="w-full border-gray-200 rounded-2xl px-4 py-3 focus:ring-red-500 focus:border-red-500 @error('email') border-red-500 @enderror" value="{{ old('email', $lecturer->email) }}">
                @error('email') <span class="text-red-500 text-xs mt-1">{{ $message }}</span> @enderror
            </div>

            <div class="mb-4">
                <label class="block text-gray-700 font-bold mb-2 text-sm uppercase tracking-wide">NIP</label>
                <input type="text" name="nip" class="w-full border-gray-200 rounded-2xl px-4 py-3 focus:ring-red-500 focus:border-red-500 @error('nip') border-red-500 @enderror" value="{{ old('nip', $lecturer->nip) }}">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nidn" class="w-full border-gray-200 rounded-2xl px-4 py-3 focus:ring-red-500 focus:border-red-500 @error('nidn') border-red-500 @enderror" value="{{ old('nidn', $lecturer->nidn) }}">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="position" class="w-full border-gray-200 rounded-2xl px-4 py-3 focus:ring-red-500 focus:border-red-500 @error('position') border-red-500 @enderror" value="{{ old('position', $lecturer->position) }}">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="expertise" class="w-full border-gray-200 rounded-2xl px-4 py-3 focus:ring-red-500 focus:border-red-500 @error('expertise') border-red-500 @enderror" value="{{ old('expertise', $lecturer->expertise) }}">
            ...
            <div class="mb-4">
                ...
                @if($lecturer->photo)
                    <div class="mb-2">
                        <img src="{{ asset('storage/' . $lecturer->photo) }}" class="w-20 h-20 rounded-2xl object-cover border">
                    </div>
                @endif
            ...
            <div class="mb-4">
                ...
                <input type="url" name="google_scholar_url" class="w-full border-gray-200 rounded-2xl px-4 py-3 focus:ring-red-500 focus:border-red-500 @error('google_scholar_url') border-red-500 @enderror" value="{{ old('google_scholar_url', $lecturer->google_scholar_url) }}">
            ...
            <div class="mb-4">
                ...
                <input type="url" name="sinta_url" class="w-full border-gray-200 rounded-2xl px-4 py-3 focus:ring-red-500 focus:border-red-500 @error('sinta_url') border-red-500 @enderror" value="{{ old('sinta_url', $lecturer->sinta_url) }}">
            ...
            <div class="mb-4">
                ...
                <input type="number" name="order" class="w-full border-gray-200 rounded-2xl px-4 py-3 focus:ring-red-500 focus:border-red-500 @error('order') border-red-500 @enderror" value="{{ old('order', $lecturer->order) }}">
                @error('order') <span class="text-red-500 text-xs mt-1">{{ $message }}</span> @enderror
            </div>

            <div class="mb-4 flex items-center h-full">
                <label class="flex items-center cursor-pointer">
                    <input type="checkbox" name="is_active" value="1" class="hidden peer" {{ old('is_active', $lecturer->is_active) ? 'checked' : '' }}>
