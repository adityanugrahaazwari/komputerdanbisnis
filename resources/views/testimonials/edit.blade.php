        ...
        <form action="{{ route('testimonials.update', $testimonial->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="name" class="w-full bg-gray-50 border border-gray-100 rounded-2xl px-4 py-3 text-sm focus:ring-2 focus:ring-red-500 transition outline-none @error('name') border-red-500 @enderror" value="{{ old('name', $testimonial->name) }}" placeholder="Contoh: John Doe, S.Kom" required>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="quote" rows="5" class="w-full bg-gray-50 border border-gray-100 rounded-2xl px-4 py-3 text-sm focus:ring-2 focus:ring-red-500 transition outline-none @error('quote') border-red-500 @enderror" placeholder="Berikan kutipan testimoni..." required>{{ old('quote', $testimonial->quote) }}</textarea>
